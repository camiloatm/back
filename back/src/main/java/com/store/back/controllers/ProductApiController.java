...
public class ProductApiController implements ProductApi {
  ...
  @Override
  public ResponseEntity<Set<ProductDetail>> getProductSimilar(String productId) throws ProductException {
    LOGGER.info("Start getProductSimilar");
    return ResponseEntity.ok(this.productHandler.searchSimilarProducts(productId));
  }
}
